...
def test_connect_success(mock_psycopg_connect):
...
def test_connect_failure(mock_psycopg_connect):
...
def test_close_connection(mock_psycopg_connect):
...
def test_prepare_schema_success(mock_psycopg_connect):
...
def test_prepare_schema_failure(mock_psycopg_connect):
...
def test_prepare_schema_not_connected():
...
def test_bulk_load_stream_success(mock_psycopg_connect):
...
def test_bulk_load_stream_failure(mock_psycopg_connect):
...
def test_bulk_load_not_connected():
...
def test_commit_rollback_safe(mock_psycopg_connect):
